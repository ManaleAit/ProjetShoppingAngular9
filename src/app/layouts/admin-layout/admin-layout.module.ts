...
@NgModule({
  ...
  providers: [   ServiceUserService,ServiceCommandeService,ServiceMessageContactService,ServiceClientService],//,{ provide: HTTP_INTERCEPTORS, useClass: ErrorInterceptor, multi: true },{provide: HTTP_INTERCEPTORS, useClass: TokenInterceptor, multi: true}],
